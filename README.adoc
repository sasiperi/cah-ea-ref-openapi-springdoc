...
<1> Most of the specifc overrides can aslo easyly be handled via "application.properties". The comprehensive list of what can be handled via application configuration is here: https://springdoc.org/springdoc-properties.html[Asciidoctor]
